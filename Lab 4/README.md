...
# For peer review: I plan on using the distance sensor to make a device that follows my hand using the distance sensor and servo motor. The device will respond to my hand motions to enable a puppet-like interaction with no strings. Any feedback on this idea is appreciated. 
